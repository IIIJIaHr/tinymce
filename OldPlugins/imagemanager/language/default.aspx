...
<%@ Import Namespace="MR.Web.MC.Manager" %>
<%@ Import Namespace="MR.Web.MC.Manager.Utils" %>
<%
	...
	try {
		if (type != null) {
            ...
            MR.Web.MC.Manager.Utils.GroupCollection groups = langPack.Languages[man.Config.Get("general.language", "en")].Groups;
			...
			if (format != null && format == "tinymce") {
				...
				foreach (string groupName in groups.Keys) {
                    MR.Web.MC.Manager.Utils.Group group = (MR.Web.MC.Manager.Utils.Group)groups[groupName];
