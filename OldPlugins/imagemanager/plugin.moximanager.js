...
(function (exports, undefined) {
    ...
    var __moxman_util_Loader = "moxman/util/Loader",
        ...
        __moxman_interop_CkEditorPlugin = "moxman/interop/CkEditorPlugin";
    ...
    define(__moxman_Env, [], function () {
        var nav = navigator,
            ...
            webkit, ie, mac, android, iDevice, phone, tablet;
    ...
    define(__moxman_Loader,
        [__moxman_util_Loader,
            __moxman_Env,
            __moxman_util_I18n
        ...
        function createThrobber() {
            var blocker = document.createElement("div"),
                ...
                blocker.style.zIndex = 16777215;
                throbber.style.zIndex = 16777215;
            ...
            function loadAndRender(view) {
                ...
                return function (settings) {
                    var langCode, cacheSuffix = Env.cacheSuffix,
                        throbber;
                    ...
                    if (!moxman.ui) {
                        ...
                        ResourceLoader.load({
                            js: [appendCacheSuffix(Env.baseUrl + "/js/moxman.api.min.js"), Env.apiPageUrl + "?action=language" + (langCode ? "&code=" + langCode : "")],
                            css: [appendCacheSuffix(Env.baseUrl + "/skins/" + (settings.skin || "lightgray") + "/skin" + (Env.ie7 ? ".ie7" : "") + ".min.css")]
                        }, function () {
                            throbber.hide();
                            moxman.ui.FloatPanel.zIndex = (settings.zIndex || moxman.ui.FloatPanel.zIndex) + 65535;
    ...
    /**
     * Integrate to tinymce as plugin
     */
                    ...
                    oninsert: function (args) {
                        ...
                        tinymce.each(args.files, function (file, i) {
                            ...
                            if (/\.(gif|jpe?g|png)$/i.test(file.name)) {
                                ...
                                videoTemplate += "</video>";
                                html += processTemplate(editor.getParam("moxiemanager_video_template", videoTemplate), file);
                            } else {
    ...
    define(__moxman_interop_CkEditorPlugin, [__moxman_Loader, __moxman_Env], function (Loader, Env) {
        if (!window.CKEDITOR) {
            return {}
        }
    ...
    expose([__moxman_util_Loader, __moxman_Env, __moxman_util_I18n, __moxman_Loader, __moxman_interop_TinyMcePlugin, __moxman_interop_CkEditorPlugin]);
